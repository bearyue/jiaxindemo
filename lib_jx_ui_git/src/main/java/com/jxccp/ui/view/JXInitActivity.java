...
public class JXInitActivity extends FragmentActivity implements JXWorkGroupAdapter.OnEnterGroupListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatkey = getIntent().getStringExtra(Constants.EXTRA_CHAT_KEY);
        chatTitlekey = getIntent().getStringExtra(Constants.EXTRA_CHAT_TITLE_KEY);
        msgBoxEnable = getIntent().getBooleanExtra(Constants.EXTRA_MSG_BOX_KEY, false);
