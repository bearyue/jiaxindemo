...
public class NotificationUtils {
    ...
    public static void notifyRecallIncoming(Context context, String skillsId){
        ...
        intent.putExtra(Constants.EXTRA_INTENT_TYPE, false);
    ...
    public static void showIncomingMessageNotify(Context context, JXMessage jxmessage){
        ...
        if(type !=null ){
            ...
            intent.putExtra(Constants.EXTRA_INTENT_TYPE, true);
        ...
        switch (messageType) {
            case TEXT:
                ...
                if (JXCommonUtils.isHtmlText(message)) {
                    message = message.replaceAll("<img src=(.*?)[^>]*?>", context.getString(R.string.jx_image_message));
